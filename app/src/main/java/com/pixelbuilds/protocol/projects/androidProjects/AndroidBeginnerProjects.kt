...
class AndroidBeginnerProjects : Fragment() {
   ...
   override fun onCreateView(
      ...
      val toProgrammingLanguages=view.findViewById<AppCompatImageButton>(R.id.programmingLanguage_knowmore)
       ...
       itemDescription.add("This application will be used to make a fake call to the device. This application is generally essential for emergency situations. This can be good for situations where the users are alone and in danger. This app will help them pretend like they’re on call and walk out of the path." +
       ...
       itemDescription.add("This application will enable college students to communicate with each other on a single platform. It will give them the facility to chat, and share important notice through it. There will be a login page for the users and a code to join the same group." +
       ...
       itemDescription.add("This project is specially developed to help people manage their routines properly. This will let users make a timely routine of each day so they can follow it. This will be more useful for the students or the college-going youth." +
       ...
       itemDescription.add("This is a nice project idea for beginners. This application is to enable the delivery of food to the passengers of trains who travel long distances. This application will ensure the passengers have a pleasant journey as they’ll be able to order food through the application." +
       ...
       itemDescription.add("Online Parental Control Application is an application aimed at helping parents to have control over their children. It’ll help them keep track of their kids’ health and their study. This system will have modules Admin, Parent, and Children. The range of children varies in groups like for 1-4, 5-7, 8-11, and teenage." +
       ...
       itemDescription.add("This is the application developed to teach children counting, alphabets, and other very basic but essential things in an interactive manner. It will have the lessons section wise to help parents teach their kids anywhere. This will help kids to learn with fun while playing itself." +
       ...
       itemDescription.add("This application will aim at helping its users by converting the units from one another. This app will take input from the user and convert it to the desired unit and give the result. For example, it will be able to convert a value in centimeters to Meters or grams to kilograms and vice versa." +
