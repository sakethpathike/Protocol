...
class AndroidAdvancedProjects : Fragment() {
    ...
    override fun onCreateView(
       ...
       itemTitle.add("4. Android based Bluetooth Chat")
        itemDescription.add("This is a very simple but useful project idea, to enable people to chat with each other even if they do not have the internet. This is a bluetooth chatting app that enables users to create profiles and chat with a server with the help of the device’s bluetooth." +
        ...
        itemDescription.add("This project, Remote Control Robot Car, aims at making a straightforward robot with strong computational platforms. This will help the users to learn and improve their programming skills with this project. We will control this robot car wirelessly using the Android application, " +
