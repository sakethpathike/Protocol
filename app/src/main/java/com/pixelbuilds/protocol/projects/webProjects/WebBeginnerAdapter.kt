...
class WebBeginnerAdapter(private var title: List<String>, private var description: List<String>) :
    RecyclerView.Adapter<WebBeginnerAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.webbeginner_items, parent, false)
